...
class ProClass extends StatefulWidget {
  ...
  ProClass(this.privateClassId,this.privateClassName,this.privateClassDesc,this.privateClassPrice);

  @override
  _ProClassState createState() => _ProClassState(privateClassId,privateClassName,privateClassDesc,privateClassPrice);
}

class _ProClassState extends State<ProClass> {
  ...
  _ProClassState(this.privateClassId,this.privateClassName,this.privateClassDesc,this.privateClassPrice);
