...
class PaypalPaymentPrivate extends StatefulWidget {
  String course_id;
  String course_name;
  String course_price;
  //final Function onFinish;

  PaypalPaymentPrivate(this.course_id,this.course_name,this.course_price);

  @override
  State<StatefulWidget> createState() {
    return PaypalPaymentPrivateState(course_id,course_name,course_price);
  }
}

class PaypalPaymentPrivateState extends State<PaypalPaymentPrivate> {
  String course_id;
  String course_name;
  String course_price;
  PaypalPaymentPrivateState(this.course_id,this.course_name,this.course_price);
  ...
  Map<String, dynamic> getOrderParams() {
    ...
    Map<String, dynamic> temp = {
        ...
        "id": "P-8NS21456F1445761PMCKTC6I",
        "product_id": "PROD-1SM07137JA6696712",
        "name": "Private Plan",
        "status": "ACTIVE",
        "description": "Private plan",
        "usage_type": "LICENSED",
        "create_time": "2021-05-07T12:24:25Z",
        "links": [
          {
            "href": "https://api.paypal.com/v1/billing/plans/P-8NS21456F1445761PMCKTC6I",
            "rel": "self",
            "method": "GET",
          ...
          {
            "href": "https://api.paypal.com/v1/billing/plans/P-8NS21456F1445761PMCKTC6I/deactivate",
            "rel": "self",
            "method": "POST",
            "encType": "application/json"
          }
