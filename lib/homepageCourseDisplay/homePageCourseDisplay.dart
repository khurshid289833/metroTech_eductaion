...
class HomePageCourseDisplay extends StatefulWidget {
  @override
  _HomePageCourseDisplay createState() => _HomePageCourseDisplay();
}

class _HomePageCourseDisplay extends State<HomePageCourseDisplay> {
  ...
  Future _loadData() async {
    ...
    inc==true? _homePageCourseDisplayFuture =   _homepageCourseDisplayRepository.HomepageCourseDisplayRepositoryFunction(page):null;
    _homePageCourseDisplayFuture.whenComplete(() =>
        setState(() {
        isLoading = false;
        inc = false;
        streamCheck = true;
  ...
  void initState() {
    ...
    _homePageCourseDisplayFuture = _homepageCourseDisplayRepository.HomepageCourseDisplayRepositoryFunction(pageno1);
    setState(() {
      streamCheck = true;
    });
    super.initState();
                    ...
                    if (snapshot.data.courses != null) {
                      if(streamCheck)
                      {
                        ...
                        for(i=0;i<snapshot.data.courses.data.length;i++)
                        {
                          ...
                          rating.add(snapshot.data.courses.data[i].courseRating);
                          count.add(snapshot.data.courses.data[i].courseReview);
